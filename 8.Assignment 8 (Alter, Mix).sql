...
alter table flights add column FlightStatus varchar(100) default 'Scheduled';
...
update flights set ticketprice=1500 where departurecity='london';
...
alter table flights add column DepartureTerminal varchar(100) default 'T1';
...
update flights set flightstatus = 'Boarding' where departurecity = 'New York';
...
-- 16. Update the departure terminal to 'T2' for all flights with FlightStatus 'boarding'.
update flights set departureterminal = 'T2' where flightstatus = 'boarding';
...
alter table flights add column gatenumber varchar(100) default 'A1';
