...
select o.orderid, o.orderdate, concat(c.firstname,' ',c.lastname) as fullname
...
-- 10. Retrieve the orders made by customers from a specific country ('USA').
select c.firstname, c.lastname,c.country, o.orderid 
from orders o join customers c on o.customerid = c.customerid where c.country='usa';
...
select orderid, totalamount from orders where totalamount > 500;

-- 14. Show the customers along with the number of orders they've placed.
select c.firstname, c.lastname, count(o.orderid) 
from orders o right join customers c 
on o.customerid = c.customerid group by c.firstname, c.lastname;
